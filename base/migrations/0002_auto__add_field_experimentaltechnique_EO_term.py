...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentalTechnique.EO_term'
        db.add_column(u'base_experimentaltechnique', 'EO_term',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentalTechnique.EO_term'
        db.delete_column(u'base_experimentaltechnique', 'EO_term')
    ...
    models = {
        ...
        u'base.curation': {
            ...
            'TF_instances': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['base.TFInstance']", 'symmetrical': 'False'}),
        ...
        u'base.curation_siteinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_high_throughput': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'base.experimentaltechnique': {
            'EO_term': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
