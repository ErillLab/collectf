...
urlpatterns = patterns('browse.browse_tax',
...
urlpatterns += patterns('browse.browse_tech',
    (r'browse_tech/$', 'browse_tech'),
    url(r'^get_results_tech/(?P<type_>\w+)/(?P<id>\d+)/$', 'get_results_tech'),
)

urlpatterns += patterns('browse.search',
    (r'search/$', 'search'),
)

urlpatterns += patterns('browse.view_curation',
    (r'^view_curation/(?P<cid>\d+)/$', 'view_curation'),
)

urlpatterns += patterns('browse.view_reports',
    (r'view_reports/$', 'view_reports'),
)

urlpatterns += patterns('browse.json_views',
    (r'get_genomes/$', 'get_genomes'),
    (r'get_TF_instances/$', 'get_TF_instances'),
)

urlpatterns += patterns('browse.stats',
...
urlpatterns += patterns('browse.export',
    url(r'^export/$', 'export_sites'),
)

urlpatterns += patterns('browse.compare',
