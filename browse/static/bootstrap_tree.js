...
!function ($) {
    ...
    Node = function (element, options) {
        ...
        if (this.subroot === undefined) {
            ...
            this.element.prepend('<span class="tree-node tree-bullet"><i class="fa fa-caret-down" ></i>  </span>');
        }
    ...
    Node.prototype = {
        ...
        toggle: function () {
            if (this.subroot !== null && this.subroot !== undefined) {
                ...
                this.icon.find('i').eq(0).toggleClass('fa-caret-right');
                this.icon.find('i').eq(0).toggleClass('fa-caret-down');
            }
        },
        collapse: function (recursive) {
            if (this.subroot !== null && this.subroot !== undefined) {
                ...
                this.icon.find('i').eq(0).addClass('fa').addClass('fa-caret-right');
                this.icon.find('i').eq(0).removeClass('fa-caret-down');
            }
        },
